...
//    playbackControlRootView.setVisibility(View.INVISIBLE);
    ...
    public void setPlayPause(boolean shouldPlay) {
        ...
        if (shouldPlay) {
            ...
            //wingoku
            if (ingrainListener != null)
                ingrainListener.onPlayerPlay();
        } else {
            playerControl.pause();
            if (ingrainListener != null)
                ingrainListener.onPlayerPause();
        }
    ...
    // WinGoku's code
    private IngrainEvents ingrainListener;

    public void setIngrainEventListener(IngrainEvents listener) {
        ingrainListener = listener;
    }

    public interface IngrainEvents {
