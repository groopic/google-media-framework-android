 ...
 */
public class ImaPlayer implements PlaybackControlLayer.FullscreenCallback{
    ...
    /**
     * Wingoku - IngrainSDK stuff
     */
    private String videoID, apiKey;
    ...
    public ImaPlayer(Activity activity,
                     ...
                     String adTagUrl,
                     PlaybackControlLayer.FullscreenCallback fullscreenCallback, String videoID, String apiKey) {
    ...
    public ImaPlayer(Activity activity,
                     ...
                     String videoTitle,
                     ImaSdkSettings sdkSettings,
                     String adTagUrl, String videoID, String apiKey) {
        this(activity, container, video, videoTitle, sdkSettings, adTagUrl, null, videoID, apiKey);
    }
    ...
    public ImaPlayer(Activity activity,
                     FrameLayout container,
                     Video video,
                     String videoTitle, String videoID, String apiKey) {
        this(activity,
                container,
                video,
                videoTitle,
    ...
    public ImaPlayer(Activity activity,
                     FrameLayout container,
                     Video video, String videoID, String apiKey) {
        this(activity,
                container,
                video,
                "",
    ...
    private void createAdPlayer() {
        ...
        adPlayer = new SimpleVideoPlayer(activity,
                ...
                true,
                0,
                fullscreenCallback, true, videoID, apiKey);
